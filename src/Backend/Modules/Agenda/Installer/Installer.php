    ...
    public function install()
    {
        ...
        foreach ($this->getLanguages() as $language) {
            ...
            if (!(bool)$this->getDB()->getVar(
                ...
                // insert page
                $this->insertPage(array('title' => 'Agenda', 'language' => $language), null,
                    array('extra_id' => $agendaId));
            }
        ...
        $this->setNavigation($navigationAgendaId, 'Agenda', 'agenda/index', array(
            'agenda/add',
            'agenda/edit',
            'agenda/media',
            'agenda/add_image',
        ...
        $this->setNavigation($navigationAgendaId, 'Categories', 'agenda/categories',
            array('agenda/add_category', 'agenda/edit_category'));
        $this->setNavigation($navigationAgendaId, 'Subscriptions', 'agenda/subscriptions',
