...
<div class="pageTitle">
    <h2>{$lblAgenda|ucfirst}: {$lblAdd}</h2>
</div>
                ...
                <tr>
                    ...
                    <td id="sidebar">
                        ...
                        <div class="box">
                            <div class="heading">
                                <h3>
                                    <label for="beginDateDate">{$lblDateAndTime|ucfirst}<abbr
                            ...
                            <div id="wholeDay">
                                <div class="options">
                                    {$chkWholeDay} <label
                                            for="whole_day">{$lblWholeDay|ucfirst} </label> {$chkWholeDayError}
                                </div>
                            </div>
                            <div class="options">
                                <div id="recurringAgendaContainer">
                                    {$chkRecurring} <label
                                            for="recurring">{$lblRepeatAgenda|ucfirst} </label> {$chkRecurringError}
                                </div>
                                ...
                                <div id="recurringAgendaOptions">
                                    ...
                                    <div id="recurringIntervalContainer" class="recurringOptions">
                                        ...
                                        {$ddmInterval} {$ddmIntervalError} <label
                                                id="interval">{$lblDays|ucfirst}</label>
                                    </div>
        ...
        <div id="tabLocation">
            <div class="box">
                ...
                <div class="horizontal">
                    <div class="options">
                        <label for="venue">{$lblName|ucfirst}</label>
                    ...
                    <div class="options">
                        ...
                        <p>
                            <label for="zip">{$lblZip|ucfirst}</label>
                            {$txtZip} {$txtZipError}
                        </p>
                        <p>
