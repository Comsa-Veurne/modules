...
{form:edit}
                ...
                <tr>
                        ...
                        <div class="box" id="formElements">
                            ...
                            <div class="horizontal">
                                <div id="specificationsHolder" class="sequenceByDragAndDrop">
                                    ...
                                    <div id="noSpecifications"
                                         class="options"{option:specifications} style="display: none;"{/option:specifications}>
                                        {$lblNoSpecifications}
                                    </div>
                                </div>
                            </div>
                    ...
                    <td id="sidebar">
                        ...
                        <div class="box">
                            ...
                            <div class="options">
                                <label for="frontpage">{$lblFrontpage|ucfirst}</label>
                                {$chkFrontpage}
                            </div>
                            <div class="options">
                                <label for="frontpage">{$lblContact|ucfirst}</label>
                                {$chkContact}
                            </div>
                        </div>
    ...
    <div class="fullwidthOptions">
        <a href="{$var|geturl:'delete'}&amp;id={$product.id}" data-message-id="confirmDelete"
