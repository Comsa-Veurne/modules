        ...
        <div class="options">
            <ul class="inputList">
                ...
                <li>
					...
					<span class="helpTxt">
						{$msgHelpSpamFilter}
                        {option:noAkismetKey}<span class="infoMessage">
                            <br/>
                        {$msgNoAkismetKey|sprintf:{$var|geturl:'index':'settings'}}</span>{/option:noAkismetKey}
					</span>
                </li>
            </ul>
        </div>
    ...
    <div class="box">
        ...
        <div class="options">
            <ul class="inputList p0">
                <li>
                    <label for="notifyByEmailOnNewCommentToModerate">{$chkNotifyByEmailOnNewCommentToModerate} {$msgNotifyByEmailOnNewCommentToModerate|ucfirst}</label>
                </li>
                <li>
                    <label for="notifyByEmailOnNewComment">{$chkNotifyByEmailOnNewComment} {$msgNotifyByEmailOnNewComment|ucfirst}</label>
                </li>
            </ul>
        </div>
    </div>
