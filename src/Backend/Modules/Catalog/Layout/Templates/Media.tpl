...
<div class="tabs">
    ...
    <div id="tabFiles">
        <div class="buttonHolderRight">
            <a href="{$var|geturl:'add_file'}&amp;product_id={$product.id}" class="button icon iconAdd"
               title="{$lblAddFile|ucfirst}">
        ...
        <div id="dataGridProductFilesHolder">
            {option:dataGridFiles}
                <div class="dataGridProductsHolder">
                    <form action="{$var|geturl:'mass_media_action'}" method="get" class="forkForms submitWithLink"
                          id="massAction">
                        <fieldset>
                            <input type="hidden" name="product_id" value="{$product.id}"/>
                            {$dataGridFiles}
    ...
    <div id="tabVideos">
        <div class="buttonHolderRight">
            <a href="{$var|geturl:'add_video'}&amp;product_id={$product.id}" class="button icon iconAdd"
               title="{$lblAddVideo|ucfirst}">
