...
jsFrontend.catalog =
{
    ...
    init: function ()
    {
        ...
        jsFrontend.catalog.images();
        //jsFrontend.catalog.specifications();
    },
    ...
    images: function ()
    {
        $("a[id^=catalog-product-image-]").click(function (e)
        {
            ...
            if (id != undefined)
            {
                ...
                $("li[id^=catalog-product-large-image-]").hide();
                $("li#catalog-product-large-image-" + id).show();
    ...
    specifications: function ()
    {
        if ($(window).width() > 720)
        {
            ...
            $("dl.specifications dd").each(function (e, o)
            {
                var Dt = $(this).prev();
                var heightDd = $(this).outerHeight();
                var heightDt = $(Dt).outerHeight();

                if (heightDd > heightDt)
                {
                    $(Dt).css('height', heightDd + 'px');
                }
                else if (heightDd < heightDt)
                {
                    $(this).css('height', heightDt + 'px');
                }
            });
        }
    }
