...
{option:showMoreButton}
    <button class="btn btn-default pull-right more-pictures" type="submit">{$lblMorePictures|ucfirst}</button>
    <button class="btn btn-default pull-right less-pictures" type="submit">{$lblLessPictures|ucfirst}</button>
{/option:showMoreButton}
    <!-- /.container-galleria -->
